...
/**
 * Test the SAML EncryptedElementType encrypted key resolver, with keys as
 * peers.
 */
public class EncryptedElementTypeEncryptedKeyResolverTest extends BaseTestCase {
	...
	public void testSingleEKNoRecipients() {
		String filename = "/data/org/opensaml/saml2/encryption/EncryptedElementTypeEncryptedKeyResolverSingleNoRecipient.xml";
	...
	/**
	 * Multiple recipients specified to resolver, one EncryptedKey in instance
	 * with no recipient.
	 */
	...
	/**
	 * One recipient specified to resolver, one matching EncryptedKey in
	 * instance.
	 */
	public void testSingleEKOneRecipientWithMatch() {
		String filename = "/data/org/opensaml/saml2/encryption/EncryptedElementTypeEncryptedKeyResolverSingleWithRecipient.xml";
		EncryptedAssertion encAssertion = (EncryptedAssertion) unmarshallElement(filename);
	...
	/**
	 * One recipient specified to resolver, zero matching EncryptedKey in
	 * instance.
	 */
	...
	/**
	 * One recipient specified to resolver, one matching & and one
	 * recipient-less EncryptedKey in instance.
	 */
	...
	/**
	 * Multi recipient specified to resolver, several matching EncryptedKey in
	 * instance.
	 */
