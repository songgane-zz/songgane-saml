...
public class SimpleEncryptionTest extends BaseTestCase {
	...
	/**
	 * Test basic encryption with symmetric key, no key wrap, set key name in
	 * passed KeyInfo object.
	 */
	@Test
	public void testAssertion() {
		...
		assertEquals("Algorithm attribute", algoURI, encTarget.getEncryptedData().getEncryptionMethod().getAlgorithm());
		...
		assertEquals("Number of EncryptedKeys", 0, encTarget.getEncryptedData().getKeyInfo().getEncryptedKeys().size());
	...
	public void testAssertionAsID() {
		...
		assertNotNull("Encrypted object was null", encObject);
		assertTrue("Encrypted object was not an instance of the expected type", encObject instanceof EncryptedID);
	...
	public void testNewID() {
		...
		assertNotNull("Encrypted object was null", encObject);
		assertTrue("Encrypted object was not an instance of the expected type", encObject instanceof NewEncryptedID);
	...
	/**
	 * Test that reuse of the encrypter with the same encryption and key
	 * encryption parameters is allowed.
	 */
	...
	/**
	 * Test that an error is thrown if the no data encryption credential is
	 * supplied and no KEK is specified.
	 */
