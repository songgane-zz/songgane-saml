...
public class IdpMetadata {
	 ...
	 */
	public IdpMetadata(File metadataFile) throws SAMLException {
	 ...
	 *             process the metadata
	 */
	public IdpMetadata(InputStream inputStream) throws SAMLException {
		init(inputStream);
	}
	...
	private void init(InputStream inputStream) throws SAMLException {
		...
		find_cert_loop: for (KeyDescriptor kdesc : idpDesc.getKeyDescriptors()) {
